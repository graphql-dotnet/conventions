...
namespace GraphQL.Conventions.Tests.Adapters
{
    public class TypeMappingTests : ConstructionTestBase
    {
        ...
        {
            Type<TestEnum?>().ShouldBeOfType<EnumerationGraphType<TestEnum>>();
        }

        [Fact]
        public void Can_Derive_Non_Nullable_Enum_Types()
        {
            Type<TestEnum>().ShouldBeOfNonNullableType<EnumerationGraphType<TestEnum>>();
        }
        ...
        {
            Type<List<TestEnum?>>().ShouldBeOfListType<EnumerationGraphType<TestEnum>>();
        }

        [Fact]
        public void Can_Derive_Nullable_Lists_Of_Non_Nullable_Enum_Types()
        {
            Type<List<TestEnum>>().ShouldBeOfListType<NonNullGraphType<EnumerationGraphType<TestEnum>>>();
        }
        ...
        {
            Type<NonNull<List<TestEnum?>>>().ShouldBeOfNonNullableListType<EnumerationGraphType<TestEnum>>();
        }

        [Fact]
        public void Can_Derive_Non_Nullable_Lists_Of_Non_Nullable_Enum_Types()
        {
            Type<NonNull<List<TestEnum>>>().ShouldBeOfNonNullableListType<NonNullGraphType<EnumerationGraphType<TestEnum>>>();
        }
        ...
        {
            Type<Task<TestEnum?>>().ShouldBeOfType<EnumerationGraphType<TestEnum>>();
        }

        [Fact]
        public void Can_Derive_Future_Non_Nullable_Enum_Types()
        {
            Type<Task<TestEnum>>().ShouldBeOfNonNullableType<EnumerationGraphType<TestEnum>>();
        }
        ...
        {
            Type<Task<List<TestEnum?>>>().ShouldBeOfListType<EnumerationGraphType<TestEnum>>();
        }

        [Fact]
        public void Can_Derive_Future_Nullable_Lists_Of_Non_Nullable_Enum_Types()
        {
            Type<Task<List<TestEnum>>>().ShouldBeOfListType<NonNullGraphType<EnumerationGraphType<TestEnum>>>();
        }
        ...
        {
            Type<Task<NonNull<List<TestEnum?>>>>().ShouldBeOfNonNullableListType<EnumerationGraphType<TestEnum>>();
        }

        [Fact]
        public void Can_Derive_Future_Non_Nullable_Lists_Of_Non_Nullable_Enum_Types()
        {
            Type<Task<NonNull<List<TestEnum>>>>().ShouldBeOfNonNullableListType<NonNullGraphType<EnumerationGraphType<TestEnum>>>();
        }
